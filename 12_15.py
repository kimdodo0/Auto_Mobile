...
if __name__ == '__main__':
    ...
    try:   
        ...
        while True:
            ...
            if dist[FRONT_DIST_IDX]<40:
                
                if dist[LEFT_DIST_IDX] > dist[RIGHT_DIST_IDX] and dist[RIGHT_DIST_IDX] < 15:
                    turn_left(left_pwm,right_pwm)
                    print('1')
                    time.sleep(0.1)
                elif dist[LEFT_DIST_IDX] < dist[RIGHT_DIST_IDX] and dist[LEFT_DIST_IDX] < 15:
                    turn_right(left_pwm,right_pwm)
                    print('2')
                    time.sleep(0.1)

            if dist[FRONT_DIST_IDX]< 25 and dist[LEFT_DIST_IDX] < 25 and dist[RIGHT_DIST_IDX] <25:
                while dist[FRONT_DIST_IDX] < 5:
            ...
            elif dist[LEFT_DIST_IDX] <10:
                turn_right(left_pwm,right_pwm)
                print('4')
                time.sleep(0.1)

            elif dist[RIGHT_DIST_IDX]<10:
                turn_left(left_pwm,right_pwm)
                print('5')
                time.sleep(0.1)
