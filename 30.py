...
def forward(left_pwm,right_pwm): # 33
    left_pwm.start(33)
    right_pwm.start(33)
...
if __name__ == '__main__':
    ...
    try:
        ...
        while True:
            ...
            if dist[FRONT_DIST_IDX]< 45 and dist[LEFT_DIST_IDX] < 45 and dist[RIGHT_DIST_IDX] <35:
                GPIO.output(motor1,GPIO.HIGH)
                GPIO.output(motor2,GPIO.HIGH)
                GPIO.output(motor3,GPIO.HIGH)
                GPIO.output(motor4,GPIO.HIGH)
            ...
            elif dist[LEFT_DIST_IDX] <19:
                turn_right(left_pwm,right_pwm)
                print('4')
                time.sleep(0.1)

            elif dist[RIGHT_DIST_IDX]<17:
                turn_left(left_pwm,right_pwm)
                print('5')
                time.sleep(0.1)
